...
public class OLD_SecondOrder_1D
// Taken from the following video by t3ssel8r: https://www.youtube.com/watch?v=KPoeNZZ6H4s
{
    ...
    public OLD_SecondOrder_1D(float f, float z, float r, float originalX)
    {
        // Compute constants.
        _w = 2 * Mathf.PI * f;
        _z = z;
    ...
    public float Update(float time, float position, float inputVelocity, bool inputVelocityUnknown = false)
    {
