...
public class OLD_SecondOrder_2D
// Taken from the following video by t3ssel8r: https://www.youtube.com/watch?v=KPoeNZZ6H4s
{
    ...
    public OLD_SecondOrder_2D(float f, float z, float r, Vector2 originalVector2)
    {
        // Compute constants.
        _w = 2 * Mathf.PI * f;
        _z = z;
    ...
    public Vector2 Update(float time, Vector2 position, Vector2 inputVelocity, bool inputVelocityUnknown = false)
    {
