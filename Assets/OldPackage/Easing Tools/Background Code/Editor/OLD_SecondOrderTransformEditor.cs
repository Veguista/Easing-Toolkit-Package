...
[CustomEditor(typeof(OLD_SecondOrderTransform))]
public class OLD_SecondOrderTransformEditor : Editor
{
    OLD_SecondOrderTransform myScript;      // Holds our target script.
    OLD_SecondOrderTransform MyScript       // Provides and initializes our target script.
    {
        get
        {
            if(myScript == null)
                myScript = target as OLD_SecondOrderTransform;
    ...
    public override void OnInspectorGUI()
    {
        ...
        using (new GUILayout.VerticalScope(EditorStyles.helpBox))
        {
            ...
            if (MyScript.whichSecondOrder != OLD_SecondOrderTransform.typeOfFollow.rotationDegrees)
            {
                GUILayout.Space(5);
                ...
                if (followTransform != MyScript.followTransform
                    && MyScript.whichSecondOrder != OLD_SecondOrderTransform.typeOfFollow.rotationDegrees)
                {
            ...
            // Transform to follow
            OLD_SecondOrderTransform.typeOfFollow typeOfFollow = (OLD_SecondOrderTransform.typeOfFollow)
            ...
            if (MyScript.whichSecondOrder != OLD_SecondOrderTransform.typeOfFollow.rotationDegrees)
            {
                ...
                OLD_SecondOrderTransform.typeOfSpace obtainLocalOrWorld = (OLD_SecondOrderTransform.typeOfSpace)
                ...
                MyScript.ApplyToLocalOrWorld = OLD_SecondOrderTransform.typeOfSpace.localSpace;


            // Only position and rotationQuaternion allow local apply.
            if (MyScript.whichSecondOrder == OLD_SecondOrderTransform.typeOfFollow.position
                || MyScript.whichSecondOrder == OLD_SecondOrderTransform.typeOfFollow.rotationQuaternion)
            {
                GUILayout.Space(5);

                OLD_SecondOrderTransform.typeOfSpace applyLocalOrWorld = (OLD_SecondOrderTransform.typeOfSpace)
            ...
            if (MyScript.whichSecondOrder != OLD_SecondOrderTransform.typeOfFollow.rotationQuaternion)
            {
                GUILayout.Space(5);
    ...
    void DrawGraph()
    {
        ...
        OLD_SecondOrder_1D myDynamics = new OLD_SecondOrder_1D(MyScript.frequency, MyScript.damping, MyScript.initialResponse, 0);
    ...
    void CalculateBounds()
    {
        ...
        OLD_SecondOrder_1D myBondsCalculation =
            new OLD_SecondOrder_1D(MyScript.frequency, MyScript.damping, MyScript.initialResponse, 0);
